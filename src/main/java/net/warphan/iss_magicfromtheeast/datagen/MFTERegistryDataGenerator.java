...
public class MFTERegistryDataGenerator extends DatapackBuiltinEntriesProvider {
    ...
    // built-in registry on 1.20.1, registered in code (see MFTEBannerPatternsRegistries).
    ...
    public MFTERegistryDataGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
