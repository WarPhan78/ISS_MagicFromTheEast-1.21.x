...
import net.warphan.iss_magicfromtheeast.entity.armor.ImmortalArmorModel;
...
public class ImmortalArmorItem extends ImbuableChestplateArmorItem {
    public ImmortalArmorItem(ArmorItem.Type slot, Properties properties) {
        super(MFTEArmorMaterialRegistries.MASTER_SCHOOL_ARMOR, slot, properties,
                ...
                new AttributeContainer(MFTEAttributeRegistries.SYMMETRY_SPELL_POWER, 0.25, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)
        );
    }
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new ImmortalArmorModel());
    }
}
