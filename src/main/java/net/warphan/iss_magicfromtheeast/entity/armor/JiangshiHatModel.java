...
public class JiangshiHatModel extends DefaultedItemGeoModel<JiangshiHatItem> {
    ...
    public ResourceLocation getModelResource(JiangshiHatItem object) {
        return ResourceLocation.fromNamespaceAndPath(ISS_MagicFromTheEast.MOD_ID, "geo/jiangshi_hat.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(JiangshiHatItem object) {
        return ResourceLocation.fromNamespaceAndPath(ISS_MagicFromTheEast.MOD_ID, "textures/models/armor/jiangshi_hat.png");
    }
