...
public class SpiritAshigaruRenderer extends AbstractSpellCastingMobRenderer {
    public SpiritAshigaruRenderer(EntityRendererProvider.Context context) {
        super(context, new SpiritAshigaruModel());
