...
public class OnmyojiEntity extends NeutralWizard implements IMerchantWizard {
    public OnmyojiEntity(EntityType<? extends AbstractSpellCastingMob> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new WizardAttackGoal(this, 1.25f, 25, 50)
                ...
                .setSingleUseSpell(MFTESpellRegistries.KITSUNE_PACK_SPELL.get(), 80, 320, 6, 8)
                .setDrinksPotions()
        );
    ...
    protected void populateDefaultEquipmentSlots(RandomSource randomSource, DifficultyInstance difficultyInstance) {
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(MFTEItemRegistries.ONMYOJI_HAT.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(MFTEItemRegistries.ONMYOJI_ROBES.get()));
    ...
    public MerchantOffers getOffers() {
        if (this.offers == null) {
            ...
            this.offers.add(new AdditionalWanderingTrades.RandomScrollTrade(new SpellFilter(MFTESchoolRegistries.SPIRIT.get()), 0f, .25f).getOffer(this, this.random));
            if (this.random.nextFloat() < .8f) {
                this.offers.add(new AdditionalWanderingTrades.RandomScrollTrade(new SpellFilter(MFTESchoolRegistries.SPIRIT.get()), .3f, .7f).getOffer(this, this.random));
            }
            if (this.random.nextFloat() < .8f) {
