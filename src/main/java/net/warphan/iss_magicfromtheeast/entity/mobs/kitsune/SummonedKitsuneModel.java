...
public class SummonedKitsuneModel extends GeoModel<SummonedKitsune> {
    public static final ResourceLocation modelResource = new ResourceLocation(ISS_MagicFromTheEast.MOD_ID, "geo/kitsune.geo.json");
    public static final ResourceLocation textureResource = new ResourceLocation(ISS_MagicFromTheEast.MOD_ID, "textures/entity/kitsune.png");
    public static final ResourceLocation animationResource = new ResourceLocation(ISS_MagicFromTheEast.MOD_ID, "animations/kitsune.animation.json");
    ...
    @Override
    public void handleAnimations(SummonedKitsune animatable, long instanceId, AnimationState<SummonedKitsune> animationState, float partialTick) {
