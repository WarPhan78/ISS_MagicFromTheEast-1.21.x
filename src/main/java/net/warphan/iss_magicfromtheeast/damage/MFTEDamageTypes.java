...
public class MFTEDamageTypes {
    public static ResourceKey<DamageType> register(String name) {
        return ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(ISS_MagicFromTheEast.MOD_ID, name));
    }
    //NOTE: Temporary remove Dune since it's in very W.I.P stage
...
//    public static final ResourceKey<DamageType> DUNE_MAGIC = register("dune_magic");
    ...
    public static final ResourceKey<DamageType> SOUL_WEAPONS_BONUS = register("soul_weapons_bonus");
...
//        context.register(DUNE_MAGIC, new DamageType(DUNE_MAGIC.location().getPath(), DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0f));
        ...
        context.register(SOUL_WEAPONS_BONUS, new DamageType(SOUL_WEAPONS_BONUS.location().getPath(), DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0f));
